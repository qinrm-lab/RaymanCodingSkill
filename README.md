...
./scripts/verify-release-contract.ps1 -CliPath $artifact -ReferenceCliPath $artifact -SkillPath ./SKILL.md -WorkspaceSkillPath ./SKILL.md -SkillResourceMode Source -RequirePath -RequireSourceFresh
```
