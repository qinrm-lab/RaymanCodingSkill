...
pub const AUTHORED_MESSAGE_TEMPLATES: &[&str] = &[
    ...
    "PowerShell authority binding 与 authority goal baseline 不一致",
    "PowerShell authority goal 缺少 receipt-era baseline",
    "PowerShell replacement authority dependency binding 无效",
    "PowerShell replacement authority 缺少 receipt-era dependency binding",
    "non-PowerShell authority 不得携带 PowerShell gate binding",
...
const TEMPLATE_FRAGMENT_CATALOG: &[(&str, &str)] = &[
    ...
    (
        "无法从 captured workspace 重算 PowerShell replacement authority gate binding: {error:#}",
        "unable to recompute the PowerShell replacement authority-gate binding from the captured workspace: {error:#}",
    ),
    (
        "无法枚举 readiness goals 目录: {}",
    ...
    (
        "PowerShell authority binding 与 authority goal baseline 不一致",
        "the PowerShell authority binding does not match the authority goal baseline",
    ),
    (
        "PowerShell authority goal 缺少 receipt-era baseline",
        "the PowerShell authority goal has no receipt-era baseline",
    ),
    (
        "PowerShell replacement authority dependency binding 无效",
        "the PowerShell replacement authority dependency binding is invalid",
    ),
    (
        "PowerShell replacement authority 缺少 receipt-era dependency binding",
        "the PowerShell replacement authority has no receipt-era dependency binding",
    ),
    (
        "non-PowerShell authority 不得携带 PowerShell gate binding",
        "a non-PowerShell authority must not carry a PowerShell gate binding",
    ),
    (
        "authority receipt invocation hash 无效",
