...
use cargo_metadata::{
    CapturedManifestAuthority, cargo_metadata_topology, nested_cargo_metadata_topology,
};
#[cfg(test)]
use cargo_metadata::{
    CargoMetadataDependency, CargoMetadataDocument, CargoMetadataPackage, cargo_metadata_command,
    validate_cargo_metadata_document,
};
pub use cargo_metadata::{TOPOLOGY_TOOL_UNAVAILABLE, topology_blocked_by_missing_cargo};
